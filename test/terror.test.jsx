...
describe('terror.js — агульная логіка', () => {
  ...
  it('радок статыстыкі па пераліку КДБ: злітыя, асобныя, без даты — у абедзвюх мовах', () => {
    ...
    expect(be(738, 700, 38)).toBe('У пераліку КДБ «датычных да тэрарыстычнай дзейнасці» 738 чалавек. 700 з іх ёсць і ў пераліку МУС і на графіку ўлічваюцца як запісы МУС — па даце ўключэння і групе артыкулаў. Астатнія 38 ёсць толькі ў пераліку КДБ — гэта малінавая серыя. Дат уключэння пералік не публікуе, таму на графік яны пакуль не трапляюць: дату атрымліваюць толькі тыя, хто з’явіцца ў наступных версіях пераліку.');
    expect(be(1042, 1000, 40)).toContain('У пераліку КДБ «датычных да тэрарыстычнай дзейнасці» 1 042 чалавекі.');
    ...
    expect(be(5, 5, 0)).toBe('У пераліку КДБ «датычных да тэрарыстычнай дзейнасці» 5 чалавек. 5 з іх ёсць і ў пераліку МУС і на графіку ўлічваюцца як запісы МУС — па даце ўключэння і групе артыкулаў.');
