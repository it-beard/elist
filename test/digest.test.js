...
describe('дапаможныя', () => {
  ...
  it('адно эмодзі на спіс, пяць розных; назва — адзін радок, абрэзаная', () => {
    expect(Object.keys(ICON).sort()).toEqual(['f', 'm', 'p', 't', 'w']);
    expect(new Set(Object.values(ICON)).size).toBe(5);
    expect(Object.keys(NAME).sort()).toEqual(['f', 'm', 'p', 't', 'w']);
