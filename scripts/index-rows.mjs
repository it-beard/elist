 ...
 * асобы з пераліку КДБ «прычастных да тэрарыстычнай дзейнасці» (у базе list 't') — на сайце не асобны спіс, а частка
