...
export function siteFacts(meta = {}) {
  ...
  return {
    ...
    // пералік КДБ — асобы, прычастныя да тэрарыстычнай дзейнасці (0, пакуль не імпартаваны); на сайце — у спісе асоб
    terror: tm.total || 0,
...
export const FAQ = {
  be: [
    ...
    {
      q: 'Што такое пералік асоб, прычастных да тэрарыстычнай дзейнасці (КДБ), і як ён паказваецца на сайце?',
...
export const SUMMARY = {
  be: (f) => `Пошук па экстрэмісцкіх спісах Беларусі: ${f.totalStr} запісаў Рэспубліканскага спісу экстрэмісцкіх матэрыялаў${f.formations ? `, ${f.formationsStr} запісаў пераліку экстрэмісцкіх фарміраванняў МУС/КДБ` : ''}${f.persons ? `${f.wanted ? ',' : ' і'} ${f.personsStr} чалавек з пераліку фізічных асоб МУС` : ''}${f.wanted ? ` і ${f.wantedStr} беларусаў у базе вышуку РФ (паводле Медыязоны)` : ''}${f.terror ? `, а таксама ${f.terrorStr} чалавек з пераліку КДБ, прычастных да тэрарыстычнай дзейнасці,` : ''} на ${f.updatedStr}, абнаўленне двойчы на дзень. Праверце нік, Telegram-канал, сайт, кнігу ці імя, дадайце запыт у спіс назірання. Працуе афлайн, не збірае ніякіх даных.`,
...
export const KEY_FACTS = {
  be: (f) => [
    ...
    ...(f.terror ? [['Чалавек у пераліку КДБ, прычастных да тэрарыстычнай дзейнасці (па беларускіх справах)', `${f.terrorStr} (версія пераліку ад ${f.terrorSourceStr}); на сайце — у спісе асоб з пазнакай «тэрарыст · КДБ»`]] : []),
    ['Абнаўленне', 'аўтаматычна, двойчы на дзень'],
    ['Крыніца', 'афіцыйная публікацыя Рэспубліканскага спісу экстрэмісцкіх матэрыялаў; пералікі экстрэмісцкіх фарміраванняў і фізічных асоб — сайт МУС; пералік асоб, прычастных да тэрарыстычнай дзейнасці, — файл КДБ з яго Telegram-канала; база вышуку РФ па беларусах — штодзённая выбарка Медыязоны-Беларусь'],
