...
export const FAQ = {
  ...
  en: [
    ...
    },
    {
      ...
      a: (f) => `They are three different lists, and the site searches all of them at once. The list of “extremist materials” is formed by courts (red left border and “Material” label) and carries administrative liability. The list of “extremist formations” is maintained by the Interior Ministry and the KGB${f.formations ? ` (${f.formationsStr} entries, checked once a day)` : ''}; such results carry a purple left border and “Formation” label. ${LEGAL_EN.crime} The list of individuals “involved in extremist activity” is kept by the Interior Ministry${f.persons ? ` (${f.personsStr} people, checked twice a day)` : ''}: people with a conviction or another court decision under “extremism” articles, marked with a teal left border and “Person” label. The tabs under the search box — “All records · Materials · Formations · Persons” — show how many matches each list has and limit the results to one list. Many resources and people appear on several lists at once.`,
    },
    {
