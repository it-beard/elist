...
export const FAQ = {
  be: [
    ...
    },
    {
      ...
      a: () => 'Праверце тэкст запісу, дату і падставу — назву суда для матэрыялаў, рашэнне МУС/КДБ для фарміраванняў, прысуд і дату нараджэння для фізічнай асобы (у пераліку шмат цёзак): менавіта яны вызначаюць, што і калі прызналі экстрэмісцкім. Для фарміравання адказнасць крымінальная, таму варта звярнуцца па кансультацыю адразу. Калі вы ў базе вышуку РФ, вас могуць затрымаць і выдаць не толькі ў Расіі, але і ў краінах, якія з ёй супрацоўнічаюць, — перад паездкамі пракансультуйцеся з праваабаронцамі. Дадайце запыт у спіс назірання, каб убачыць, калі з’явіцца новы звязаны запіс. Пра свае рызыкі і магчымасць абскарджання пракансультуйцеся з праваабаронцамі: Праваабарончы цэнтр «Вясна» і Human Constanta.',
    },
    {
  ...
  en: [
    ...
    },
    {
      ...
      a: () => 'Check the entry text, the date and the grounds — the court name for materials, the Interior Ministry / KGB decision for formations, the verdict and the date of birth for a person (the list has many namesakes): they define what was ruled extremist and when. For a formation the liability is criminal, so seek advice right away. If you are in the RF wanted database, you can be detained and extradited not only in Russia but also in countries that cooperate with it — consult rights defenders before travelling. Add the query to your watchlist to see when a related entry appears. Consult human rights defenders about your risks and possible appeal: Viasna Human Rights Centre and Human Constanta.',
    },
    {
