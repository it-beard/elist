...
export function siteFacts(meta = {}) {
  const fm = meta.formations || {}, pm = meta.persons || {}, wm = meta.wanted || {}, tm = meta.terror || {};
  return {
    total: meta.total || 0,
    ...
    // пералік КДБ — асобы, датычныя да тэрарыстычнай дзейнасці (0, пакуль не імпартаваны); на сайце — у спісе асоб
    terror: tm.total || 0,
    terrorStr: fmtNum(tm.total || 0),
    terrorUpdatedStr: fmtDay(tm.checked || tm.updated),
    terrorSourceStr: fmtDay(tm.sourceDate || tm.checked || tm.updated),
  };
}
...
const PERS_BE = (f) => (f.persons ? ` Трэці спіс — пералік фізічных асоб, «датычных да экстрэмісцкай дзейнасці» (МУС): ${f.personsStr} чалавек з прысудам (радзей — іншым рашэннем суда) па «экстрэмісцкіх» артыкулах КК (правяраецца двойчы на дзень).` : '');
...
const LEGAL_BE = {
  ...
  persons: 'У пералік фізічных асоб трапляюць, як правіла, людзі з прысудам, які ўступіў у сілу, па «экстрэмісцкіх» артыкулах КК (найчасцей 342, 130, 368, 369, 361-х); радзей — асобы, справу якіх суд спыніў па нерэабілітавальных падставах ці якім прызначыў прымусовае лячэнне. Паводле закона «Аб супрацьдзеянні экстрэмізму» уключэнне цягне за сабой абмежаванні — у прыватнасці, на педагагічную і выдавецкую дзейнасць, дзяржаўную і вайсковую службу, валоданне зброяй — да пагашэння ці зняцця судзімасці і яшчэ пяць гадоў пасля; выключаюць з пераліку праз пяць гадоў пасля пагашэння (зняцця) судзімасці, пры адмене прысуду або смерці.',
  terror: 'У пералік КДБ трапляюць людзі з прысудам па «тэрарыстычных» і сумежных артыкулах КК (289, 290-1–290-5, 293, 295, 359, а таксама 130 і 361) і тыя, каго па іх толькі абвінавацілі — яшчэ да суда, нярэдка завочна. Банкі і іншыя фінансавыя арганізацыі абавязаныя замарожваць сродкі і блакаваць аперацыі асоб з пераліку, а перадача такому чалавеку грошай ці маёмасці можа лічыцца фінансаваннем тэрарыстычнай дзейнасці (арт. 290-1 КК). Дат уключэння і выключэння пералік не публікуе.',
};
const LEGAL_EN = {
  ...
  terror: 'The KGB list holds people convicted under “terrorism” and related articles of the Criminal Code (289, 290-1–290-5, 293, 295, 359, as well as 130 and 361) and people merely charged under them — before any trial, often in absentia. Banks and other financial institutions must freeze the assets and block the transactions of listed persons, and giving such a person money or property may count as financing terrorist activity (Art. 290-1 CC). The list publishes no dates of inclusion or removal.',
};
...
export const FAQ = {
  be: [
    ...
    {
      q: 'Што такое пералік фізічных асоб, датычных да экстрэмісцкай дзейнасці?',
      a: (f) => `Пералік грамадзян Беларусі, замежнікаў і асоб без грамадзянства, «датычных да экстрэмісцкай дзейнасці», вядзе МУС і публікуе некалькімі .doc-файламі на сваім сайце${f.persons ? ` (на ${f.personsUpdatedStr} у ім ${f.personsStr} чалавек)` : ''}. ${LEGAL_BE.persons} У кожным запісе — прозвішча, імя і імя па бацьку, лацінская транслітарацыя, грамадзянства, дата нараджэння, падстава (суд і артыкулы прысуду), дата ўключэння і месцазнаходжанне. Сайт паказвае гэтыя запісы з бірузовай палоскай і плашкай «Асоба» і дазваляе шукаць па імені кірыліцай ці лацінкай, а даты нараджэння («д.н.») дапамагаюць адрозніць цёзак. Даведку з пераліку («адбывае пакаранне», «судзімасць не пагашана») сайт не паказвае: МУС не абнаўляе яе ва ўжо апублікаваных частках, таму ў старых запісах яна часта састарэлая. Затое на старонцы запісу ёсць спасылка на самую .doc-частку пераліку, у якой чалавек ёсць цяпер, — можна праверыць першакрыніцу.`,
    },
    {
      q: 'Што такое база вышуку РФ па беларусах і адкуль гэтыя даныя?',
      a: (f) => `Гэта не афіцыйны спіс Беларусі, а выбарка з базы вышуку МУС РФ: грамадзяне і ўраджэнцы Беларусі, якіх Расія абвясціла ў вышук. Сама база МУС РФ аддае толькі пошук па імені з капчай і не адказвае з-за мяжы, таму даныя бяруцца са штодзённай выбаркі Медыязоны-Беларусь, якая публікуе іх адкрыта${f.wanted ? ` (на ${f.wantedSourceStr} у вышуку ${f.wantedStr} чалавек)` : ''}; сайт правярае гэтую выбарку двойчы на дзень і паказвае дату яе файла ў шапцы. ${LEGAL_BE.wanted} У кожным запісе — прозвішча, імя і імя па бацьку (як у базе, па-руску), год нараджэння, нацыянальнасць, ведамства Беларусі, па чыім запыце абвешчаны вышук, і яго рэгіён, дата абвяшчэння ў вышук (у часткі запісаў — прыблізная, «да …»), іншыя напісанні імя і пазнака, калі чалавек выключаны з базы. Сайт паказвае гэтыя запісы з бурштынавай палоскай і плашкай «Вышук РФ», а калі той жа чалавек (тое ж імя і год нараджэння) ёсць і ў пераліку фізічных асоб МУС, абедзве карткі спасылаюцца адна на адну.`,
    },
    {
      q: 'Што такое пералік асоб, датычных да тэрарыстычнай дзейнасці (КДБ), і як ён паказваецца на сайце?',
      a: (f) => `Гэта афіцыйны «Перечень организаций и физических лиц, причастных к террористической деятельности», які вядзе КДБ: фізічныя асобы і арганізацыі з рашэннямі беларускіх судоў і КДБ, а побач — замежнікі і арганізацыі з санкцыйных пералікаў ААН (іх сайт не паказвае)${f.terror ? `; на ${f.terrorSourceStr} у ім ${f.terrorStr} чалавек па беларускіх справах` : ''}. ${LEGAL_BE.terror} Большасць гэтых людзей ёсць і ў пераліку фізічных асоб МУС, таму на сайце пералік КДБ не асобны спіс: яго людзі ідуць у тым жа спісе «Асобы». Хто ёсць у абодвух пераліках — адной карткай пераліку МУС з малінавай плашкай «тэрарыст · КДБ» і палямі пераліку КДБ на старонцы запісу; каго ў пераліку МУС няма — асобнай карткай з малінавай палоскай і плашкай «Тэрарыст · КДБ». Слова «тэрарыст» у пошуку знаходзіць іх усіх. У кожным запісе — прозвішча, імя і імя па бацьку, транслітарацыя, грамадзянства, дата нараджэння, адрас, падстава (прысуд ці абвінавачанне з артыкуламі КК) і нумар у пераліку; дат уключэння пералік не публікуе, таму сайт паказвае версію пераліку, у якой запіс з’явіўся. Афіцыйная старонка пераліку на сайце КДБ з-за мяжы часта не адказвае; абнаўленні КДБ публікуе файлам у сваім Telegram-канале, і сайт бярэ іх адтуль.`,
    },
    {
      q: 'Што пагражае за рэпост ці захоўванне матэрыялу са спісу?',
      a: () => `${LEGAL_BE.admin} На практыцы падставай для пратакола бываюць стары рэпост, захаваны файл, стыкер ці спасылка ў перапісцы. Гэта не юрыдычная кансультацыя: пры рэальнай праблеме звярніцеся да праваабаронцаў.`,
    },
    {
      q: 'Ці лічыцца парушэннем сама падпіска на канал са спісу?',
    ...
    },
    {
      ...
      a: (f) => `Гэта чатыры розныя спісы, і сайт шукае адразу па ўсіх. Спіс «экстрэмісцкіх матэрыялаў» фармуюць суды — за яго парушэнне адміністрацыйная адказнасць; запісы маюць чырвоную палоску і плашку «Матэрыял» з артыкулам рашэння. Пералік «экстрэмісцкіх фарміраванняў» вядуць МУС і КДБ${f.formations ? ` (${f.formationsStr} запісаў, правяраецца раз на суткі)` : ''}; у выніках пошуку такія запісы пазначаныя фіялетавай палоскай і плашкай «Фарміраванне». ${LEGAL_BE.crime} Пералік фізічных асоб, «датычных да экстрэмісцкай дзейнасці», вядзе МУС${f.persons ? ` (${f.personsStr} чалавек, правяраецца двойчы на дзень)` : ''}: гэта людзі з прысудам ці іншым рашэннем суда па «экстрэмісцкіх» артыкулах, пазначаныя бірузовай палоскай і плашкай «Асоба». Пералік асоб, «датычных да тэрарыстычнай дзейнасці», вядзе КДБ${f.terror ? ` (${f.terrorStr} чалавек па беларускіх справах)` : ''}: на сайце гэта не асобны спіс, а частка спісу асоб — такія людзі маюць малінавую плашку «тэрарыст · КДБ». База вышуку МУС РФ па беларусах${f.wanted ? ` (${f.wantedStr} чалавек, выбарка Медыязоны абнаўляецца штодня)` : ''} — не афіцыйны спіс Беларусі: у расійскі вышук трапляюць па запыце беларускіх ведамстваў; такія запісы пазначаныя бурштынавай палоскай і плашкай «Вышук РФ». Укладкі пад полем пошуку «Усе · Матэрыялы · Фарміраванні · Асобы · Вышук РФ» паказваюць, колькі знойдзена ў кожным спісе, і абмяжоўваюць вынікі адным спісам. Многія рэсурсы і людзі ёсць адразу ў некалькіх спісах.`,
    },
    {
  ...
  en: [
    ...
    },
    {
      ...
      a: (f) => `The list of citizens of Belarus, foreign nationals and stateless persons “involved in extremist activity” is kept by the Interior Ministry and published as several .doc files on its website${f.persons ? ` (${f.personsStr} people as of ${f.personsUpdatedStr})` : ''}. ${LEGAL_EN.persons} Each entry carries the surname, first name and patronymic, a Latin transliteration, citizenship, date of birth, the grounds (court and articles of the verdict), the date of inclusion and location. The site shows these entries with a teal left border and “Person” label, lets you search by name in Cyrillic or Latin, and the dates of birth (“b.”) help tell namesakes apart. The reference note from the list (“serving the sentence”, “conviction not expunged”) is not shown: the Interior Ministry does not update it in parts it has already published, so in older entries it is often out of date. Instead, the record page links to the very .doc part of the list that currently contains the person, so you can check the primary source.`,
    },
    {
    ...
    {
      q: 'What is the KGB list of individuals involved in terrorist activity, and how is it shown on the site?',
      a: (f) => `It is the official “List of organisations and individuals involved in terrorist activity” kept by the KGB: individuals and organisations with decisions of Belarusian courts and the KGB, alongside foreigners and organisations from UN sanctions lists (the site does not show those)${f.terror ? `; as of ${f.terrorSourceStr} it holds ${f.terrorStr} people in Belarusian cases` : ''}. ${LEGAL_EN.terror} Most of these people are also on the Interior Ministry list of individuals, so on the site the KGB list is not a separate list: its people appear in the same “Persons” list. Those on both lists appear as a single Interior Ministry card with a crimson “terrorist · KGB” label and the KGB list fields on the entry page; those not on the Interior Ministry list appear as their own card with a crimson left border and “Terrorist · KGB” label. The word “terrorist” in the search finds them all. Each entry carries the surname, first name and patronymic, a transliteration, citizenship, date of birth, address, the grounds (a verdict or charges with Criminal Code articles) and the number in the list; the list publishes no inclusion dates, so the site shows the version of the list in which the entry appeared. The official list page on the KGB website often does not respond from abroad; the KGB publishes updates as a file in its Telegram channel, and the site takes them from there.`,
    },
    {
    ...
    },
    {
      ...
      a: (f) => `They are four different lists, and the site searches all of them at once. The list of “extremist materials” is formed by courts (red left border and “Material” label) and carries administrative liability. The list of “extremist formations” is maintained by the Interior Ministry and the KGB${f.formations ? ` (${f.formationsStr} entries, checked once a day)` : ''}; such results carry a purple left border and “Formation” label. ${LEGAL_EN.crime} The list of individuals “involved in extremist activity” is kept by the Interior Ministry${f.persons ? ` (${f.personsStr} people, checked twice a day)` : ''}: people with a conviction or another court decision under “extremism” articles, marked with a teal left border and “Person” label. The list of individuals “involved in terrorist activity” is kept by the KGB${f.terror ? ` (${f.terrorStr} people in Belarusian cases)` : ''}: on the site it is not a separate list but part of the persons list — such people carry a crimson “terrorist · KGB” label. The Russian Interior Ministry wanted database of Belarusians${f.wanted ? ` (${f.wantedStr} people, Mediazona’s extract is updated daily)` : ''} is not an official Belarusian list: people get there at the request of Belarusian agencies; such entries carry an amber left border and “RF wanted” label. The tabs under the search box — “All · Materials · Formations · Persons · RF wanted” — show how many matches each list has and limit the results to one list. Many resources and people appear on several lists at once.`,
    },
    {
...
export const KEY_FACTS = {
  be: (f) => [
    ...
    ...(f.terror ? [['Чалавек у пераліку КДБ, датычных да тэрарыстычнай дзейнасці (па беларускіх справах)', `${f.terrorStr} (версія пераліку ад ${f.terrorSourceStr}); на сайце — у спісе асоб з пазнакай «тэрарыст · КДБ»`]] : []),
    ['Абнаўленне', 'аўтаматычна, двойчы на дзень'],
    ['Крыніца', 'афіцыйная публікацыя Рэспубліканскага спісу экстрэмісцкіх матэрыялаў; пералікі экстрэмісцкіх фарміраванняў і фізічных асоб — сайт МУС; пералік асоб, датычных да тэрарыстычнай дзейнасці, — файл КДБ з яго Telegram-канала; база вышуку РФ па беларусах — штодзённая выбарка Медыязоны-Беларусь'],
