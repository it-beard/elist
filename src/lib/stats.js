...
// фізічныя асобы (трэці спіс): група артыкулаў КК, па якіх вынесены прысуд, і асобна — людзі з пераліку КДБ
// «прычастных да тэрарыстычнай дзейнасці», якіх няма ў пераліку МУС (гл. person.js, terror.js);
