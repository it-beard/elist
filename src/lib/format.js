...
/** Праз колькі гадзін без праверкі крыніцы шапка папярэджвае, што база магла састарэць (норма — 2 праверкі на суткі). */
export const STALE_HOURS = 36;
export const hoursSince = (d) => (Date.now() - new Date(d).getTime()) / 36e5;
