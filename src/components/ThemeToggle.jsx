...
const LABEL = { system: 'Тэма: як у сістэме', light: 'Тэма: светлая', dark: 'Тэма: цёмная' };
...
export default function ThemeToggle() {
  ...
  return (
    <button type="button" className="theme" title={`${LABEL[mode]} — націсьніце, каб зьмяніць`} aria-label={LABEL[mode]} onClick={() => setMode(next)}>
