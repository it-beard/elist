 ...
 * Асоба з пераліку КДБ «датычных да тэрарыстычнай дзейнасці», якой няма ў пераліку МУС, — той жа спіс асоб, але
 ...
 * на запіс МУС.
 * Вышук РФ (паводле Медыязоны) — бурштынавая палоска і плашка
