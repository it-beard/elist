 ...
 * не абнаўляе яе ва ўжо апублікаваных частках. Калі той жа чалавек ёсць і ў пераліку КДБ «датычных да тэрарыстычнай
...
export default function RecordPage({ id, items, chunkSize, watch, meta }) {
  ...
  const details = rec && !rec.error && !rec.stale ? (
    isW ? [
      ...
      // той жа чалавек у пераліку КДБ «датычных да тэрарыстычнай дзейнасці» — палі адтуль (foldTerror пры зборцы)
      ...(rec.kgb ? [
