...
/**
 * Укладкі-спісы пад пошукам: «Усе запісы · Матэрыялы · Фарміраванні · Асобы» з лічбамі — колькі знойдзена ў кожным спісе
 ...
 * lists — якія дадатковыя спісы ёсць у базе ({ f, p }); counts — { all, m, f, p }.
 */
